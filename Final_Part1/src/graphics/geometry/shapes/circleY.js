...
class Circle2 extends Geometry {
 /**
  ...
  constructor(shader,x,y,red,green,blue,size,segments) {
      ...
      this.translationMatrix_1.setTranslate(0,1.2*check,0);
      ...
      this.translationMatrix_3.setTranslate(+0.7*check,+0.2*check,0);

      this.translationMatrix_4 = new Matrix4();
      this.translationMatrix_4.setTranslate(-0.7*check,+0.2*check,0);
